...
description: Declare approval tiers in policy data, hold the exchange, and
  ...
  user.
slug: v1.0/guides/human-approval
---
...
Add [Approval Notifications](/v1.0/guides/approval-notifications/) if operators need push delivery, then add all terminal states to [Test Caracal Integrations](/v1.0/guides/testing/).
