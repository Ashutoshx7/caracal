...
CATALOG: tuple[Provider, ...] = (
    ...
    Provider(
        ...
        resources=("vendors", "purchase_orders", "item_receipts", "bills",
                   "payments", "journal_entries", "accounts"),
    ...
    Provider(
        ...
        resources=("contacts", "accounts", "deals", "activities", "notes",
                   "relationships", "pipelines", "owners"),
    ...
    Provider(
        ...
        resources=("messages", "templates", "message_streams", "events",
