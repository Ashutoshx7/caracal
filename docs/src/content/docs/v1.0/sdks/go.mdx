...
Use it for application authority, not management CRUD. Use [Admin Package](/v1.0/sdks/admin/) for control-plane automation.
...
| API                                                    | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `client.Session(ctx, fn, opts...)`                     | Run `fn` inside a governed Session with a bound `context.Context`; set `SessionOptions.Authority` to bound its authority and `Task` to record what the Session is for. Retry protection is automatic; ordinary code should leave `IdempotencyKey` empty. See [Safe Retries and Idempotency](/v1.0/guides/idempotency/) for durable-source redelivery.                                                                                                                                                         |
...
Session patterns for long-lived services and restart recovery are walked through in [Integrate the Go SDK](/v1.0/guides/sdk-go/).
...
* [Integrate the Go SDK](/v1.0/guides/sdk-go/)
