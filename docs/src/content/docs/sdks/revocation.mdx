...
description: RevocationStore interface, InMemoryRevocationStore implementation, and how revocation integrates with mandate verification — TypeScript and Python.
pageType: reference
---
