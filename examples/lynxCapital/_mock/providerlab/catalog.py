...
CATALOG: tuple[Provider, ...] = (
    ...
    Provider(
        ...
        tagline="Cross-border FX quotes, conversions, and transfers",
        resources=("quotes", "conversions", "transfers"),
        operations=("get_quote", "convert", "create_transfer", "get_transfer"),
    ...
    Provider(
        ...
        tagline="Enterprise vendors, bills, purchase orders, and ledger",
        resources=("vendors", "bills", "purchase_orders", "journal_entries", "accounts"),
        operations=("list_vendors", "get_vendor", "create_bill", "get_bill",
