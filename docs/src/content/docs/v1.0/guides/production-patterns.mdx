...
pageType: workflow
slug: v1.0/guides/production-patterns
---
...
Use [Protect a Gateway-Routed HTTP API](/v1.0/guides/protect-gateway-http/) for the default HTTP path. Use the framework-specific protection guides when enforcement must live in the resource server.
...
Complete the focused guide for the selected enforcement boundary, then use [Operate Caracal](/v1.0/operations/) to deploy and monitor it.
