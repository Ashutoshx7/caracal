...
Use [Proxy Through Gateway](/v1.0/api/gateway/) for the client contract and [Harden Production](/v1.0/operations/tls-hardening/) for network placement.

## Next Step

[Ingest Audit Evidence](/v1.0/services/audit/).
