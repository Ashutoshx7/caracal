...
pageType: workflow
slug: v1.0/examples/provider-preflight
---
...
Continue to [Iterate Policy Safely](/v1.0/examples/policy-iterate/) when a denied request needs to become a tested policy change.
