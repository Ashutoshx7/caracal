...
Use Console for zones, applications, providers, resources, policies, grants, sessions, audit, agents, delegation, diagnostics, and Control. Do not expect top-level runtime CLI commands for product management.
