...
ROLES: dict[str, RoleDef] = {
    ...
    "receivables": RoleDef(
        ...
        allowed_tools=(
            "issue_customer_invoice", "send_customer_invoice", "send_dunning_notice",
            "run_dunning_cycle", "apply_customer_payment", "record_customer_payment",
            "reverse_customer_payment", "get_ar_aging", "get_ar_summary",
            "get_customer_account", "get_customer_statement", "list_customer_invoices",
            "dispute_customer_invoice", "resolve_invoice_dispute",
            "issue_credit_memo", "apply_credit_memo", "list_credit_memos",
            "write_off_invoice", "open_collection_case", "add_collection_note",
            "close_collection_case", "track_message_delivery",
