      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Cloud Reference Deployments', link: '/operations/cloud-reference-deployments/' },
            ...
            { label: 'Troubleshooting Decision Tree', link: '/operations/troubleshooting/' },
            ...
            { label: 'Failure Drills', link: '/operations/failure-drills/' },
