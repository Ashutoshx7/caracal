...
upstream_prefix = "https://api.example.com"

[[optional_credentials]]
env = "CALENDAR_TOKEN"
resource = "https://api.example.com/calendar"
on_failure = "warn"
...
Credential entries use `env`, `resource`, and optional `upstream_prefix`. Runtime injection requires `env`; SDKs can also use entries as resource audiences and Gateway routing hints.
