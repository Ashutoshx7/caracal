  ...
  return [
    {
      ...
      content: systemPrompt(
        ...
        [
          ...
          'callers reach directly, without routing through the Gateway. Your executable surface defines the',
          'resource and its scopes; wiring a Gateway upstream — upstream URL, Gateway application, and the',
          'bound provider — is console setup, so define the resource and direct full upstream wiring to the',
          'console rather than fabricating a provider step you cannot complete.',
