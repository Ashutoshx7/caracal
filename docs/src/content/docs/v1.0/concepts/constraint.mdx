...
sidebar:
  order: 11
slug: v1.0/concepts/constraint
---

Read [Session Delegation](/v1.0/concepts/delegation/) first. Constraints state how far, how long, and for what a Delegation may be used. Caracal validates them when the Delegation is created and again before issuing a Mandate through it.
...
Read [Sessions and Revocation](/v1.0/concepts/sessions-revocation/) to understand how active authority ends.
