...
Use [Deploy with Docker Compose](/operations/docker-compose/), [Deploy with Helm](/operations/kubernetes-helm/), or [Deploy on a Managed Container Platform](/operations/managed-container-platforms/).
