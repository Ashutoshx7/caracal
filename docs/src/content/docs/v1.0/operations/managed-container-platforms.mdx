...
description: Run the published Caracal images on Azure Container Apps without a
  Kubernetes cluster, and know which production guarantees you trade away.
pageType: workflow
slug: v1.0/operations/managed-container-platforms
---
