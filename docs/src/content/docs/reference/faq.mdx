...
See [What Caracal Does](/get-started/what-caracal-does/) and the [One-Minute Model](/concepts/model-overview/).
...
For examples, see [Modeling Recipes](/guides/modeling-recipes/).
...
See [CLI and Console](/runtime-console/cli-and-console/).
...
Start with [Observability Workflows](/runtime-console/observability/) and [Operator Debugging](/operations/debugging/).
