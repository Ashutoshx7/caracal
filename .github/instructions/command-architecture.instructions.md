...
- Command documentation must show runtime lifecycle examples through `caracal` and product-management examples through `caracal terminal` or `caracal-console`.
