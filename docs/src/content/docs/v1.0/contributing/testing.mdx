...
pageType: reference
slug: v1.0/contributing/testing
---
...
After validation, review [Understand Governance](/v1.0/contributing/governance/) for contribution scale, review ownership, and private security process.
