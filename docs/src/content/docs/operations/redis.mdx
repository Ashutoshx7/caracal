...
| `caracal.agents.lifecycle` | None | `coordinator-relay` | Coordinator outbox |
| `caracal.invocations.lifecycle` | None | `invocations-observer` | Coordinator outbox |
| `caracal.delegations.invalidate` | None | `delegations-observer` | Coordinator outbox |
| `caracal.providers.ratelimit` | ~1 (approximate) | None | API (direct XADD) |
