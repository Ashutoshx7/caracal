...
slug: v1.0/architecture/system-topology
---
...
Use [Choose a Deployment Profile](/v1.0/operations/deployment-profiles/) for deployment choices and [Understand Services](/v1.0/services/) for service-specific failure posture.
