...
For exact payload examples, scopes, reconciliation documents, and error envelopes, use [Use the Admin API](/v1.0/api/control-plane/) and [Bootstrap Control State](/v1.0/examples/control-bootstrap/).
...
[Choose the Right Surface](/v1.0/runtime-console/cli-and-console/) for the complete boundary or [Enforce Boundaries](/v1.0/architecture/trust-boundaries/) for trust placement.
