...
description: What each deployment model requires per cloud, what ships today,
  and what a new provider must supply.
pageType: reference
slug: v1.0/operations/cloud-support-matrix
---
