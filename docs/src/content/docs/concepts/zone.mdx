...
When several boundaries could apply at once, use [Modeling Recipes](/guides/modeling-recipes/) to choose between a separate zone, a shared zone with separate resources, and a customer attribute in policy input.
