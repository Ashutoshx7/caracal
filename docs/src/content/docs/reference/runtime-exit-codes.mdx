...
description: Exit behavior for top-level caracal runtime shell commands and Console launch.
pageType: reference
---
...
`caracal status --json` emits machine-readable status. Console-owned diagnostics are available through the Console `diagnostics` view and management command catalog, not as top-level runtime shell workflows.

## Related pages

- [CLI and Console](/runtime-console/cli-and-console/)
- [Runtime Lifecycle](/runtime-console/stack/)
- [Runtime Execution](/runtime-console/runtime/)
