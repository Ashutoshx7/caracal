...
A mode setting that controls how the Caracal terminal management interface handles tool calls made through MCP (Model Context Protocol) servers. Two modes:
