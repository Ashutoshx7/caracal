...
slug: v1.0/guides/protect-fastapi
---
...
For every middleware field, use [ASGI Adapter reference](/v1.0/sdks/adapters/asgi/).

## Next Step

Replace the in-memory store with the Redis backend and run the revocation case in [Test Caracal Integrations](/v1.0/guides/testing/).
