...
<div class="notfound">
  <div class="notfound__inner">
    ...
    <p class="notfound__lede">
      New evaluator: <a href="/v1.0/get-started/">Get Started</a>. Operator: <a href="/v1.0/operations/">Operations</a>. Integrator:{' '}
      <a href="/v1.0/guides/">Guides</a>. Contributor: <a href="/v1.0/contributing/">Contributing</a>.
    </p>
  </div>
</div>
