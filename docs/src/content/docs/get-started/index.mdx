...
| Learn the full model | [One-Minute Model](/concepts/model-overview/) | The canonical concept path after first success. |
| Develop Caracal itself | [Local Setup](/contributing/setup/) | A source-tree development stack and contributor workflow. |
