---
description: "Guide onboarding a new provider by identifying provider-side setup and Caracal web console fields."
...
Guide the user through provider-side setup needed before filling Caracal web console.
...
Use provider docs and Caracal docs to identify only values that fit current Caracal web console fields:
...
Tell the user which Caracal web console field receives each value. Never ask them to paste raw secrets into chat.
