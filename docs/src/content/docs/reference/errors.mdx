...
## When you do not know where it failed

If you only have an SDK error and not the surface, start from the symptom-first [Troubleshooting Decision Tree](/operations/troubleshooting/). It routes a denied or failing call to the right surface, the object to inspect, and the diagnostic tool to use.
...
- [Troubleshooting Decision Tree](/operations/troubleshooting/)
