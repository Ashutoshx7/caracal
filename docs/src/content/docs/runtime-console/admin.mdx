...
description: Manage zones, applications, providers, resources, policies, grants, authority sessions, and Control through the Console.
pageType: reference
---
...
```text
zone -> application -> provider -> resource -> policy -> policy set -> grant -> authority session/audit
```
