...
Use [Use the Admin API](/v1.0/api/control-plane/) for route and auth reference rather than treating this service page as an endpoint catalog. Service environment variables are cataloged in [Configure Service Environment](/v1.0/operations/env-vars/).
...
[Coordinate Session State](/v1.0/services/coordinator/) or [Manage Product Objects](/v1.0/runtime-console/admin/).
