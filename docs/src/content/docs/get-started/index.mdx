...
If you first want to confirm Caracal fits your problem, read [Choose Your Path](./choose-your-path/). It answers whether Caracal can replace secrets-in-env for agents and routes you to a single next page by situation and role.
...
| Page | Use it when |
| --- | --- |
| [Choose Your Path](./choose-your-path/) | You want to decide whether Caracal fits and where to start. |
