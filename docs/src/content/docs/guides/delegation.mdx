...
description: Open child agent sessions, attach scope and TTL caveats, traverse the delegation graph, and trigger cascade revocation using the SDK and CLI.
pageType: workflow
---
...
## Attach caveats to a delegation edge
