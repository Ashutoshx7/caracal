...
| --- | --- | --- |
| Node.js | 24 | Required by the terminal interface (`engines.node: ">=24"`) |
| TypeScript | 5.x | Required by all TypeScript packages |

The TypeScript SDK, connectors (Express, net/http JS), and terminal interface all require Node.js 24 or later. Earlier Node.js releases are not tested and are not supported.
