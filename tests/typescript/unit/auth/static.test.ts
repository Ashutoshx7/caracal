...
import { cacheControlFor, resolveStaticPath, serveStatic } from '../../../../apps/auth/src/static.ts'
...
describe('resolveStaticPath', () => {
  ...
  it('contains directory traversal within the web root', () => {
    ...
    for (const attempt of ['/../../etc/passwd', '/assets/../../secret', '/%2e%2e/%2e%2e/etc/passwd', '/..%2f..%2fsecret']) {
