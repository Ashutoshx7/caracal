...
| `CARACAL_ADMIN_TOKEN` / `CARACAL_ADMIN_TOKEN_FILE` | None | Bootstrap admin token. Seeded into the database on first startup. Prefer the file-backed form for service deployments. |
