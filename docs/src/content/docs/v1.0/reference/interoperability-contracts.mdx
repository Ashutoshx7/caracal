...
pageType: reference
slug: v1.0/reference/interoperability-contracts
---
...
| Contract                            | Schema                                                                                                                                              |
| ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| Agent connector manifest            | [`caracal-agent-connector-manifest-2026-05-21.schema.json`](/v1.0/schemas/caracal-agent-connector-manifest-2026-05-21.schema.json)                       |
| Audit event                         | [`caracal-audit-event-2026-05-21.schema.json`](/v1.0/schemas/caracal-audit-event-2026-05-21.schema.json)                                                 |
| Audit exporter manifest             | [`caracal-audit-exporter-manifest-2026-05-21.schema.json`](/v1.0/schemas/caracal-audit-exporter-manifest-2026-05-21.schema.json)                         |
| Gateway upstream manifest           | [`caracal-gateway-upstream-manifest-2026-05-21.schema.json`](/v1.0/schemas/caracal-gateway-upstream-manifest-2026-05-21.schema.json)                     |
| JWT claims                          | [`caracal-jwt-claims-2026-05-21.schema.json`](/v1.0/schemas/caracal-jwt-claims-2026-05-21.schema.json)                                                   |
| Policy input                        | [`caracal-policy-input-2026-05-20.schema.json`](/v1.0/schemas/caracal-policy-input-2026-05-20.schema.json)                                               |
| Policy pack manifest                | [`caracal-policy-pack-manifest-2026-05-21.schema.json`](/v1.0/schemas/caracal-policy-pack-manifest-2026-05-21.schema.json)                               |
| Policy result                       | [`caracal-policy-result-2026-05-20.schema.json`](/v1.0/schemas/caracal-policy-result-2026-05-20.schema.json)                                             |
| Resource verifier manifest          | [`caracal-resource-verifier-manifest-2026-05-21.schema.json`](/v1.0/schemas/caracal-resource-verifier-manifest-2026-05-21.schema.json)                   |
| Revocation event                    | [`caracal-revocation-event-2026-05-21.schema.json`](/v1.0/schemas/caracal-revocation-event-2026-05-21.schema.json)                                       |
| Token response                      | [`caracal-token-response-2026-05-21.schema.json`](/v1.0/schemas/caracal-token-response-2026-05-21.schema.json)                                           |
| W3C baggage                         | [`caracal-w3c-baggage-2026-05-21.schema.json`](/v1.0/schemas/caracal-w3c-baggage-2026-05-21.schema.json)                                                 |
