...
Every evaluation receives documented Application, Resource, action, Session, Delegation, requested-scope, Subject-claim, Approval, and trace context. Use [Author Policy Data](/v1.0/guides/author-policy/) for the current field-level contract.
...
Read [Mandates](/v1.0/concepts/mandate/) to understand the short-lived proof an allowed exchange produces.
