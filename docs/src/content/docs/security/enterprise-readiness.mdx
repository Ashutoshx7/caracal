...
| Area | Control | Status |
| --- | --- | --- |
| Static analysis | CodeQL for Go, Python, TypeScript | Implemented |
| Static analysis | Semgrep rules | Implemented |
| Dependency vulnerabilities | OSV-Scanner sweep across npm, Go, Python | Implemented |
| Dependency vulnerabilities | Scheduled dependency review of merged changes | Implemented |
...
- **Detection.** CodeQL and Semgrep run on pull requests and on a schedule. OSV-Scanner runs weekly across every dependency ecosystem and reports into GitHub code scanning. Trivy scans published container images weekly for Critical and High CVEs.
