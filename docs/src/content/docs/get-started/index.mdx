...
3. Open web console guided setup with `caracal web`.
...
7. Inspect **Audit** and **Request Traces** in the web console.
...
| --- | --- | --- |
| Evaluate Caracal locally | [Install Caracal](./install-caracal/) | A verified runtime CLI, web console launcher, and local Docker prerequisite. |
