          ...
          items: [
            { label: 'Operate Caracal', link: '/operations/' },
            {
              ...
              items: [
                ...
                { label: 'Cloud Support Matrix', link: '/operations/cloud-support-matrix/' },
                { label: 'Add a Cloud Provider', link: '/operations/add-a-cloud-provider/' },
                ...
                { label: 'Deploy on a Managed Container Platform', link: '/operations/managed-container-platforms/' },
