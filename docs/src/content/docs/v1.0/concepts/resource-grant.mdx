...
sidebar:
  order: 6
slug: v1.0/concepts/resource-grant
---
...
:::note[FAQ]
[What is the difference between a resource and a provider?](/v1.0/reference/faq/#faq-009) and [why must the resource identifier stay stable?](/v1.0/reference/faq/#faq-010)
:::
...
:::note[FAQ]
[How should I design scopes?](/v1.0/reference/faq/#faq-011) and [do I manage grants directly?](/v1.0/reference/faq/#faq-012)
:::

## Next Step

Read [Providers](/v1.0/concepts/provider/) to understand the credential Caracal attaches when it calls the upstream target.
