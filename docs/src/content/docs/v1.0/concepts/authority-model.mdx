...
sidebar:
  order: 3
slug: v1.0/concepts/authority-model
---

Use this page to choose where Caracal makes and enforces an authorization decision. First understand [Caracal Mental Model](/v1.0/concepts/model-overview/).
...
Read [Zones](/v1.0/concepts/zone/) to understand the tenant boundary that owns authority data.

## Related Pages

* [Policies and Policy Sets](/v1.0/concepts/policy/) explains the decision contract.
* [Mandates](/v1.0/concepts/mandate/) explains the issued token.
* [Sessions and Revocation](/v1.0/concepts/sessions-revocation/) explains how active authority ends.
