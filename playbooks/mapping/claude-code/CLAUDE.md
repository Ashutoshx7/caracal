...
- Translate external provider dashboards, infrastructure configuration files, Claude Code project context, documentation snippets, copied UI text, and screenshots into visible Caracal web console Provider and Resource fields.
