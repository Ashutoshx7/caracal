...
description: Applications, Subjects, Federated users, Authority records, and
  governed Sessions.
sidebar:
  order: 5
slug: v1.0/concepts/principal
---
...
When you need the operator-facing view of these objects side by side - including how their IDs appear on the wire - the identity table in [Manage Runtime Authority](/v1.0/runtime-console/agents/#keep-the-identities-distinct) is the quick reference.
...
* the orchestrator is the top-level Session, or a [`start_session()`](/v1.0/sdks/python/) handle when it needs a heartbeat lease,
...
:::note[FAQ]
[What is the difference between an application, principal, and Session?](/v1.0/reference/faq/#faq-005) and [when should I use a managed application versus DCR?](/v1.0/reference/faq/#faq-007)
:::
...
Read [Resources and Grants](/v1.0/concepts/resource-grant/) to understand what identities can request.
