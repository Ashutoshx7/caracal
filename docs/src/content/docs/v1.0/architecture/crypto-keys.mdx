...
slug: v1.0/architecture/crypto-keys
---
...
Use [Rotate Keys and Secrets](/v1.0/operations/key-management/) for the operational procedure and [Configure Secret Backends](/v1.0/operations/secret-backends/) for custody options.
