...
pageType: workflow
slug: v1.0/examples/lynx-capital
---
...
[Serve Your Own Customers](/v1.0/guides/serve-customers/) pattern applied to app-only work: one
...
* [Run Echo Upstream](/v1.0/examples/echo-upstream/)
* [Launch Research Agent](/v1.0/examples/research-agent/)

## Next Step

Map one Lynx pattern - not the whole domain - onto [Model Your Application in Caracal](/v1.0/guides/modeling-recipes/) and add equivalent tests to your integration.
