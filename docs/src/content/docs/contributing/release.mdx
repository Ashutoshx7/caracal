...
The `.github/workflows/postReleaseValidation.yml` workflow triggers on release completion (or via `workflow_dispatch`) and opens a PR that adds `validation.md` and `findings/` to that directory.
